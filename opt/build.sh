...
cur_dir_name=${PWD##*/}
cur_dir=$(pwd)
seedsigner_app_repo="https://github.com/Kittyhope/SeedSigner_translation.git"
seedsigner_app_repo_branch="v0.1.0"
...
download_app_repo() {
  ...
  rm -rf ${rootfs_overlay}/opt/seedsigner.*.sha256.txt
  rm -rf ${rootfs_overlay}/opt/seedsigner.*.sha256.txt.sig
  rm -rf ${rootfs_overlay}/opt/seedsigner_os.*.pi0.img
